        ...
        <section class="landing-hero" id="kad-top" aria-labelledby="welcome-title">
          <div class="landing-hero__inner">
            <div class="landing-hero__copy">
              ...
              <h1 id="welcome-title">Mais clareza para chegar à sua <span>próxima aprovação.</span></h1>
              ...
              <div class="landing-hero__actions">
                ${button('Criar minha conta', { action: 'open-public-auth', size: 'lg', attrs: 'data-auth-mode="signup"' })}
                <a class="button button--secondary button--lg" href="#kad-tools">Ver ferramentas</a>
              </div>
            ...
            <aside class="landing-hero__signal" aria-label="O essencial do KAD">
              ...
              <ul class="landing-hero__pillars">
                ...
                <li><span>03</span><strong>Trilhas</strong><small>Próximo passo claro</small></li>
              </ul>
            </aside>
          </div>
        </section>
